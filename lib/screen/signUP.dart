        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              SizedBox(height: 10),
              textfield(email, _focusNode4, 'Username', Icons.person),
              SizedBox(height: 10),
              textfield(password, _focusNode2, 'Password', Icons.key),
              SizedBox(height: 10),
              textfield(
                  passwordConfirm, _focusNode3, 'Password', Icons.password),
              SizedBox(height: 8),
              account(),
              SizedBox(height: 20),
              SignUP_bottom(),
      ...
      child: Container(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
              prefixIcon: Icon(
                iconss,
                color: _focusNode.hasFocus ? custom_red : Color(0xffc5c5c5),
              ),
              contentPadding:
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/4697260.png'),
          ),
        ),
      ),
    );
